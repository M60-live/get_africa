...
@section('title', 'Geochemistry')
@section('description', 'Mining and Waste Geochemistry')
@section('content')



<!-- Title Bar -->
		<div class="pbmit-title-bar-wrapper5">
			<div class="container">
					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner container">
								...
								<h1 class="pbmit-tbar-title"> Geochemistry</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span>
									<a title="" href="#"><span>Geochemistry</span></a>
								</span>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-9 service-left-col" id="primary">
							<div class="pbmit-entry-content">
								...
								<p class="pbmit-firstletter">GET delivers advanced geochemical assessment services to support responsible resource development, mine water management, regulatory compliance, and long-term environmental stewardship.</p>
								...
								<div class="pbmit-custom-heading">
									<h3 class="pbmit-title">Acid Rock Drainage & Mine Waste Geochemistry</h3>
								</div>
								<div class="row pb-3">
									<div class="col-md-6">
										<ul class="list-group">
											...
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">ARD/AMD risk assessments and management strategies</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Static and kinetic leach testing (including humidity cell testing)</span>
											</li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Waste characterisation and classification</span>
											</li>
                                ...
                                <div class="pbmit-custom-heading">
									<h3 class="pbmit-title">Contaminant & Metal Management</h3>
								</div>
								<div class="row pb-3">
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Arsenic management and treatment strategies</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Cyanide management plans</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Hydrocarbon impact assessments and monitoring</span>
											</li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">DNAPL and LNAPL site characterisation</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Vapour plume surveying within the unsaturated zone</span>
											</li>
								...
								<div class="pbmit-custom-heading">
									<h3 class="pbmit-title">Water & Tailings Geochemistry</h3>
								</div>
								<div class="row pb-3">
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Geochemical reaction modelling</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Tailings treatment and water management strategies</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Water treatment options analysis and pilot/field trials</span>
											</li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Leachate characterisation and contaminant mobility assessment</span>
											</li>
								...
								<div class="pbmit-custom-heading">
									<h3 class="pbmit-title">Remediation & Closure Planning</h3>
								</div>
								<div class="row pb-3">
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Hydrocarbon remediation strategy development</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Long-term geochemical stability assessments</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Closure risk evaluation and mitigation planning</span>
											</li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Predictive geochemical modelling for post-closure performance</span>
											</li>
								...
								<div class="service-single-02-img">
									<img src="images/service/Geochemistry.jpg" class="img-fluid" alt="">
								</div>
							</div>
						</div>
							...
							<aside class="service-sidebar">
								<aside class="widget post-list">
									...
									<div class="all-post-list">
										<ul>
											<li class="post-active"><a href="#">Geochemistry</a></li>
