					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner container">
								...
								<h1 class="pbmit-tbar-title"> Environmental Assessment</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span>
									<a title="" href="#"><span>Environmental Assessment</span></a>
								</span>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-9 service-left-col" id="primary">
							<div class="pbmit-entry-content">
								...
								<div class="pbmit-custom-heading">
									<h3 class="pbmit-title">Feasibility & Early-Stage Regulatory Strategy</h3>
								</div>
								<div class="row pb-3">
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Environmental Constraints And Risk Screening</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Regulatory Pathway Mapping and Permitting Strategy</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Integration of Baseline Studies Into Feasibility Planning</span>
											</li>
										</ul>
									</div>
									<div class="col-md-6">
