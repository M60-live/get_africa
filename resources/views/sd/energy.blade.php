...
@section('title', 'Energy & Energy Transition')
@section('description', 'Energy Transition Support and Data Analysis')
@section('content')
					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner container">
								...
								<h1 class="pbmit-tbar-title"> Energy & Energy Transition</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span>
									<a title="" href="#"><span>Energy & Energy Transition</span></a>
								</span>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-9 service-left-col" id="primary">
							<div class="pbmit-entry-content">
								...
								<h5 class="pb-3">Energy Transition Services:</h5>
								<div class="pbmit-custom-heading">
									<h3 class="pbmit-title">Strategic & Feasibility Advisory</h3>
								</div>
								<div class="row pb-3">
									<div class="col-md-6">
										<ul class="list-group">
											<li class="list-group-item">
												...
												<span class="pbmit-icon-list-text">Technical and Environmental Feasibility Studies</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Energy Transition Strategy Support</span>
											</li>
											<li class="list-group-item">
												<span class="pbmit-icon-list-icon">
													<i class="pbmit-solaar-icon pbmit-solaar-icon-verified"></i>						
												</span>
												<span class="pbmit-icon-list-text">Risk-based Scenario Modelling and Decision Support</span>
											</li>
										</ul>
									</div>
									<div class="col-md-6">
